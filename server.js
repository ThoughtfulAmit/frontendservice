...
const SERVER = process.env.SERVER ? process.env.SERVER : "http://localhost:5000";
...
app.get('/', (req, res) => {
    ...
    //  "start": "SERVER=http://localhost:5000 node server.js",
    request.get(  // first argument: url + return format
        {
            url: SERVER + '/weatherforecast',  // the microservice end point for weatherforecast
...
//            {
//                url: SERVER + '/weatherforecast',  // the microservice end point for adding an event
